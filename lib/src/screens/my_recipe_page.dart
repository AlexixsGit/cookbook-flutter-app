...
class MyRecipePage extends StatefulWidget {
  ...
  MyRecipePage(this.serverController, {Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _MyRecipePageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Recipe>>(
        future: widget.serverController
            .getUserRecipes(widget.serverController.loggedUser),
